...
/* 
    if($(".about_intro_data").length){
      function number_change(){
          ...
          var num_people = new CountUp("num_people",0,Number($("#num_people").text()),0,2,options).start();
          var num_money = new CountUp("num_money",0,Number($("#num_money").text()),2,3,options).start();
          var num_patent = new CountUp("num_patent",0,Number($("#num_patent").text()),0,4,options).start();
          var num_capacity = new CountUp("num_capacity",0,Number($("#num_capacity").text()),0,5,options).start();
      ...
      var change_tops=$(".about_intro_data").offset().top+140;
