...
!function(window) {
    ...
    Waterfall.prototype = {
        ...
        _resetColumnsHeightArray: function() {
            var a, e = this.cols;
            for (this.colHeightArray.length = e,
            a = 0; e > a; a++)
                this.colHeightArray[a] = 0
        },
        layout: function(a, e) {
            var t, l, u, d, r, i, s = this.options, n = this._getItems(a), v = "css", o = s.animationOptions, c = s.colWidth, p = s.gutterWidth, h = this.colHeightArray.length, y = s.align;
            for (this.$element.append(n),
            "center" === y ? (t = (this.$element.width() - c * h - p * (h - 1)) / 2,
            t = t > 0 ? t : 0) : "left" === y ? t = 0 : "right" === y && (t = this.$element.width() - c * h - p * (h - 1)),
            u = 0,
            r = n.length; r > u; u++)
                this._placeItems(n[u], t);
            for (d = 0,
            i = this.styleQueue.length; i > d; d++)
                l = this.styleQueue[d],
                l.$el[v](l.style, o);
        ...
        _placeItems: function(a, e) {
            var t, l, u = $(a), d = this.options, r = d.colWidth, i = d.gutterWidth, s = d.gutterHeight, n = this.colHeightArray, v = (n.length,
            Math.min.apply({}, n)), o = $.inArray(v, n);
            t = o,
            l = {
                left: (r + i) * t + e,
                top: n[t]
        ...
        _resize: function() {
            var a = this.cols
              , e = this._getColumns();
            (e !== a || "left" !== this.options.align) && (this.cols = e,
            this.reLayout())
        },
        _doResize: function() {
            var a, e = this;
    ...
    $main_menu.click(function() {
        var a = $(this);
        a.hasClass("active") ? (a.find(".sub-menu").slideUp(),
        a.removeClass("active")) : ($sub_menu.slideUp(),
        $main_menu.removeClass("active"),
        a.find(".sub-menu").slideDown(),
        a.addClass("active"))
    }),
